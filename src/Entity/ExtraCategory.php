...
/**
 * @ORM\Entity(repositoryClass="App\Repository\ExtraCategoryRepository")
 * @ORM\Table(name="ho_extra_category")
 *
...
class ExtraCategory
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Extra", mappedBy="extraCategory")
     */
    private $extras;
    ...
    public function removeExtra(Extra $extra): self
    {
        if ($this->extras->contains($extra)) {
            ...
            if ($extra->getExtraCategory() === $this) {
                $extra->setExtraCategory(null);
            }
        }
